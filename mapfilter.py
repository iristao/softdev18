...
#print frequency(wordlist,'hey') #2


#=========== Find the total frequency of a group of words
def totalFreq(story, targetlist):
	return reduce (lambda x,y: x + frequency(story,y) , targetlist,0)

#print totalFreq(wordlist,['hey','of','temp']) #4


#=========== Find the most frequently occurring word
def mostFreq(story):
	return reduce(lambda a,b: a if frequency(story,a) > frequency(story,b) else b, story)


#print mostFreq(wordlist) #'list'

#=========== Full book:

metamorphosis = '''One morning, when Gregor Samsa woke from troubled dreams, he found
...
metalist = metamorphosis.translate(None, string.punctuation).lower().split()
#print metalist

print "the frequency of the word 'love': "
print frequency(metalist,'love')

print "the total frequency of the words 'improvement' and 'time': " 
print totalFreq(metalist,['improvement','time'])

print "The most frequently occurring word: " 
print mostFreq(metalist)
